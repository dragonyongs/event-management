  ...
  return (
    ...
    >
      <div className="flex flex-col space-y-6 h-[calc(100vh-158px)] overflow-y-auto overflow-x-hidden scrollbar-hidden">
        <h2 className="text-xl font-bold text-gray-800">사용자 정보 수정</h2>
        <div>
        ...
        <div>
          ...
          />
          {errors.rank && (
            <p className="mt-1 text-sm text-red-500">{errors.rank}</p>
          )}
        </div>
      ...
      <div className="flex justify-between gap-x-3 px-6 mt-6">
        ...
        <button
          ...
          className="flex-initial px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700"
        >
          삭제
        </button>
        <button
